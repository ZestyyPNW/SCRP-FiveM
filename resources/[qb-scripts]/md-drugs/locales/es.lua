...
Lang.coke = {
    ...
    needBakingSoda = 'Necesitas bicarbonato de sodio para esto',
}
...
Lang.Cornerselling = {
    ...
    comDes = 'Vende cosas en la esquina'
}
...
Lang.Deliveries = {
    targetGetDel = 'Obtener misión de entrega',
    ...
    DealerExists = 'El dealer ya existe',
    deleteDealer = {
        help = 'Eliminar un dealer',
        name = 'Nombre del dealer',
    },
    deleteDealerSuccess = 'Dealer eliminado',
    deleteDealerFail = 'Error al eliminar dealer',
}
...
Lang.lsd = {
    ...
    targetLys = 'Robar ácido lisérgico',
...
Lang.mesc = {
    targetPick = 'Recoger cactus',
    picking = 'Recogiendo cactus',
    targetDry = 'Secar cactus',
    dry = 'Secando cactus',
}
...
Lang.xtc = {
    alreadyOut = 'Ya tienes una prensa colocada',
